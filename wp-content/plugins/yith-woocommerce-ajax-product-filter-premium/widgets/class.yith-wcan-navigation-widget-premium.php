...
//                    }
                ...
                if( ! apply_filters( 'yith_wcan_skip_current_categories', $skip, $taxonomy, $terms, $count ) ){
                    ...
                    elseif( ! apply_filters( 'yith_wcan_skip_no_products_in_category', $filter_is_hierarchical, $terms, $term  ) ) {
                    ...
                    if (
                            ...
                            &&
                            apply_filters( "{$args['widget_id']}-show_product_count", true, $instance )
                    ) {
