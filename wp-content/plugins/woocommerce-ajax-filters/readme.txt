...
* Fix/Enhancement - Plugin doesn't work with WPML, but withount WooCommerce multilingual
...
* Fix/Enhancement - Speed up for "Show all values" and "Reload amount of products" option (WooCommerce 2.6.2 and newer)
